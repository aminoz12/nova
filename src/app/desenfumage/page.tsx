...
export default function DesenfumageService() {
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden mb-8">
              <div className="relative w-full h-80 md:h-96 lg:h-[500px]">
                <img 
                  src="/services/desenfumage.png" 
                  alt="Désenfumage - Évacuation des Fumées"
                  className="w-full h-full object-contain bg-gradient-to-br from-orange-50 to-white p-8"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-white/60 via-transparent to-transparent"></div>
              </div>
              
              <div className="p-8 md:p-10">
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">DÉSENFUMAGE</h1>
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Systèmes de désenfumage pour l'évacuation des fumées en cas d'incendie
                </p>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-blue-600 pl-6 py-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Les systèmes de désenfumage sont essentiels pour évacuer les fumées toxiques et maintenir 
                      des zones de circulation sûres pendant un incendie. Nous concevons, installons et maintenons 
                      des systèmes de désenfumage naturel et mécanique conformes aux normes de sécurité incendie.
                    </p>
                  </div>

                  <div className="border-l-4 border-green-600 pl-6 py-2">
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">Types de Systèmes</h3>
                    <ul className="text-gray-600 space-y-3">
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Désenfumage naturel par tirage thermique</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Désenfumage mécanique (ventilation)</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Systèmes d'extraction des fumées</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Commandes automatiques et manuelles</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="border-l-4 border-orange-600 pl-6 py-2">
                    ...
                    <ul className="text-gray-600 space-y-3">
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Parkings souterrains</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Immeubles de grande hauteur</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-blue-50 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Évacuation efficace des fumées toxiques</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-green-50 transition-colors">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">Conformité Réglementaire</h4>
                    <p className="text-gray-600">Respect des normes ERP/IGH</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-orange-50 transition-colors">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">Rapidité d'Intervention</h4>
                    <p className="text-gray-600">Systèmes automatiques et fiables</p>
                  </div>
                </div>
      ...
      {showContact && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setShowContact(false)}>
          <div className="bg-white rounded-2xl max-w-md w-full p-8" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Parler à un expert Désenfumage</h3>
