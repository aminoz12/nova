...
export default function ExtincteursService() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
              ...
              <div className="p-8 md:p-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-4 border-green-600 pl-6 py-2">
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">Types d'Extincteurs</h3>
                  ...
                  <div className="border-l-4 border-orange-600 pl-6 py-2">
                    ...
                    <ul className="text-gray-600 space-y-3">
                      <li className="flex items-start">
                        ...
                        <span>Analyse des risques et dimensionnement</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Vérification et maintenance annuelle</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-orange-600 mr-3 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-red-50 transition-colors">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">Protection Immédiate</h4>
                    <p className="text-gray-600">Intervention rapide sur les débuts d'incendie</p>
                  </div>
                </div>
      ...
      {/* Contact Modal */}
      {showContact && <ContactModal serviceName="Extincteurs" onClose={() => setShowContact(false)} />}
      <Footer />
    </main>
  )
}
