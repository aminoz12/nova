...
import { Phone, FileText, ArrowRight, Shield, Clock, Award, Users, CheckCircle, Wrench, Settings, Hammer } from 'lucide-react'
            ...
            <div className="bg-white rounded-3xl shadow-2xl overflow-hidden mb-8">
              <div className="relative w-full h-80 md:h-96 lg:h-[500px]">
                <img 
                  ...
                  alt="Maintenance - Protection Incendie"
              ...
              <div className="p-8 md:p-10">
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">MAINTENANCE</h1>
                <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                  Maintenance et entretien complet de tous vos équipements de sécurité incendie
                </p>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-blue-600 pl-6 py-2">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Notre service de maintenance complète assure le bon fonctionnement de tous vos équipements de sécurité incendie. 
                      Nous garantissons la conformité réglementaire de vos installations et prolongeons la durée de vie de vos équipements 
                      grâce à un entretien préventif et curatif réalisé par des techniciens certifiés.
                    </p>
                  </div>

                  <div className="border-l-4 border-green-600 pl-6 py-2">
                    <h3 className="text-xl font-semibold text-gray-900 mb-3">Types de Maintenance</h3>
                    <ul className="text-gray-600 space-y-3">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Maintenance corrective sur défaillance</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
                        <span>Contrat de maintenance annuelle et préventive.</span>
                      </li>
                      </ul>
                  </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-blue-50 transition-colors">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">Fiabilité Garantie</h4>
                    <p className="text-gray-600">Équipements toujours opérationnels</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-4 rounded-xl hover:bg-purple-50 transition-colors">
                  <div className="w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center flex-shrink-0">
                    <Hammer className="w-7 h-7 text-purple-600" />
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">Intervention Rapide</h4>
                    <p className="text-gray-600">Dépannage sous 24h</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {showContact && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50" onClick={() => setShowContact(false)}>
          <div className="bg-white rounded-2xl max-w-md w-full p-8" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Parler à un expert Maintenance</h3>
