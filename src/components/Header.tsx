                ...
                <div className="absolute top-full left-0 mt-2 w-80 xl:w-96 bg-white shadow-xl rounded-lg p-4 xl:p-6 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 border border-gray-100">
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li><a href="#" className="text-sm text-gray-600 hover:text-red-600 transition-colors block">Évaluation des Risques Incendie</a></li>
                      <li><a href="#" className="text-sm text-gray-600 hover:text-red-600 transition-colors block">Maintenance</a></li>
                      <li><a href="#" className="text-sm text-gray-600 hover:text-red-600 transition-colors block">Intervention Rapide en Cas d'Urgence</a></li>
                      <li><a href="#" className="text-sm text-gray-600 hover:text-red-600 transition-colors block">Installation Matériaux de Protection Incendie</a></li>
                      <li><a href="#" className="text-sm text-gray-600 hover:text-red-600 transition-colors block">Formation Utilisation Extincteur</a></li>
                    </ul>
                  </div>
                </div>
              </div>
                  ...
                  <div className="pl-4 pr-4 py-2 space-y-1 bg-gray-50 rounded-lg mt-1">
                    <div>
                      ...
                      <div className="space-y-1">
                        <a href="#" className="block px-3 py-2 text-sm text-gray-600 hover:text-red-600 hover:bg-white rounded transition-colors">Évaluation des Risques Incendie</a>
                        <a href="#" className="block px-3 py-2 text-sm text-gray-600 hover:text-red-600 hover:bg-white rounded transition-colors">Maintenance</a>
                        <a href="#" className="block px-3 py-2 text-sm text-gray-600 hover:text-red-600 hover:bg-white rounded transition-colors">Intervention Rapide en Cas d'Urgence</a>
                        <a href="#" className="block px-3 py-2 text-sm text-gray-600 hover:text-red-600 hover:bg-white rounded transition-colors">Installation Matériaux de Protection Incendie</a>
                        <a href="#" className="block px-3 py-2 text-sm text-gray-600 hover:text-red-600 hover:bg-white rounded transition-colors">Formation Utilisation Extincteur</a>
                      </div>
                    </div>
                  </div>
                )}
